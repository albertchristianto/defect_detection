...
parser.add_argument('--dataset_path', default='E:/Dataset/unknown_road_crack', type=str, metavar='DIR', help='path to unknown road crack dataset')
parser.add_argument('--out_dataset_path', default='E:\Albert Christianto\Project\defect_detection\dataset', type=str, metavar='DIR', help='path to unknown road crack dataset')
args = parser.parse_args()

magnetic_tile_path = os.path.join(args.out_dataset_path, 'road_crack')
create_folder(magnetic_tile_path)
normal_class_path = os.path.join(magnetic_tile_path, 'Normal/unknown')
create_folder(normal_class_path)
defect_class_path = os.path.join(magnetic_tile_path, 'Defect/unknown')
