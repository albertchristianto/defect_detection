...
mobilenetv3_param = {
    ...
    "large": "https://download.pytorch.org/models/mobilenet_v3_large-5c1a4163.pth"
}
...
def _mobilenet_v3(
    ...
    if pretrainedPath is not None:
        the_url = mobilenetv3_param[arch]
...
def Get_MobileNetV3_Backbone(arch, pretrained_path):
    inverted_residual_setting = _mobilenet_v3_conf(arch)
    return _mobilenet_v3(inverted_residual_setting, arch, pretrained_path), 224

if __name__ == "__main__":
    model_type = 'small'
    model, input_size = Get_MobileNetV3_Backbone(model_type, 'weights/')
