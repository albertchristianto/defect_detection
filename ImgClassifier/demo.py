...
def run():
    ...
    parser.add_argument('--input_path', default='D:/Data/DataSet/mask', type=str, metavar='DIR', help='path to train list')
    parser.add_argument('-b', '--batch_size', default=2, type=int,
                                            metavar='N', help='batch size (default: 16)')
    parser.add_argument('--weight_path', default='checkpoint/20220727-2221/epoch_99.pth', type=str, metavar='DIR',
    ...
    parser.add_argument('--class_name_path', default='D:/Data/DataSet/mask/classes_name.txt', type=str, metavar='DIR',
                                            help='path to weight of the model')
